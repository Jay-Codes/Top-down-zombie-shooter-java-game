 ...
 * @author Jay
 */
public class quitBtn extends  UIComponent{
    
    BufferedImage currImage , bgImage , hvrImage;

    public quitBtn(Scene scene) {
        super(scene);
        width = 156;
        height = 66;
        position.x = 352;
    ...
    public void init(){
        super.init();
        try {
            bgImage = Util.loadImageFromFile("resources/images/ui/Home/quitbtn.png");
            hvrImage = Util.loadImageFromFile("resources/images/ui/Home/quitbtnhvr.png");
            currImage = bgImage;
